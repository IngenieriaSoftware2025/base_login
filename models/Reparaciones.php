...
class Reparaciones extends ActiveRecord
{
    ...
    {
        $sql = "SELECT r.id_reparacion, r.numero_orden, r.tipo_celular, r.marca_celular, 
                       r.imei, r.motivo_ingreso, r.diagnostico, r.fecha_ingreso, 
                       r.fecha_asignacion, r.fecha_entrega_real, r.tipo_servicio, 
                       r.estado_reparacion, r.costo_total, r.id_cliente, 
                       r.id_usuario_recibe, r.id_usuario_asignado,
                       c.primer_nombre || ' ' || c.primer_apellido AS nombre_cliente,
                       u1.primer_nombre || ' ' || u1.primer_apellido AS usuario_recibe_nombre,
                       u2.primer_nombre || ' ' || u2.primer_apellido AS usuario_asignado_nombre
                FROM reparaciones r 
